...
<div class="leftnav">
    ...
    <ul style="display:block">
        ...
        <li><a href="${path}/updatepassword.do" target="right"><span class="icon-caret-right"></span>修改密码</a></li>
        <li><a href="${path}/userlist.do" target="right"><span class="icon-caret-right"></span>用户信息</a></li>
        <li><a href="${path}/handlelist.do" target="right"><span class="icon-caret-right"></span>商品分类</a></li>
        <li><a href="${path}/product.do" target="right"><span class="icon-caret-right"></span>商品信息</a></li>
